  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // GLC primary blue — used for CTA buttons, focused rings, active states
        documenso: {
          DEFAULT: '#007CFA',
          50: '#E5F3FF',
          100: '#B8DAFF',
        ...
        // GLC blue-gray neutral — based on navy #2B3674 / muted #A3AED0
        dawn: {
          DEFAULT: '#A3AED0',
          50: '#F4F7FE',
          100: '#E9EDF7',
        ...
        // GLC gradient blue scale — from light #86B6FF to deep #184EFF
        water: {
          DEFAULT: '#86B6FF',
          50: '#EFF5FF',
          100: '#DAEAFF',
